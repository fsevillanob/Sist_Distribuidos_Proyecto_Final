...
public class TareaServlet extends HttpServlet {
    ...
    protected void doGet(HttpServletRequest req, HttpServletResponse res) throws ServletException, IOException {
        ...
        try {
            ...
            // Estilos extra para garantizar inputs blancos sobre fondo oscuro
            out.println("<style>");
            ...
            out.println("::-webkit-calendar-picker-indicator { filter: invert(1); }"); // Pone el icono del calendario en blanco
            out.println("</style>");
            ...
            // FORMULARIO PARA CREAR TAREA (Derecha)
            ...
            // Pasamos la variable 'search' a DBManager
    ...
    protected void doPost(HttpServletRequest req, HttpServletResponse res) throws ServletException, IOException {
        ...
        try {
            ...
            // Después de cualquier acción POST, volvemos al listado principal
